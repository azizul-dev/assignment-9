      ...
      <form onSubmit={onSubmit} className="p-6 md:p-10 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <TextField name="petName" isRequired>
            ...
            <Input placeholder="e.g. Buddy" className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
          ...
          <div>
            <Select name="species" isRequired className="w-full">
              <Label className="text-white/80 text-sm mb-1 block">Species</Label>
          ...
          <TextField name="breed">
            ...
            <Input placeholder="e.g. Labrador Retriever" className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
            <FieldError className="text-red-300" />
          </TextField>

          {/* Age */}
          <TextField name="age" isRequired>
            <Label className="text-white/80 text-sm mb-1 block">Age (years)</Label>
            <Input type="number" placeholder="e.g. 2" className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
            <FieldError className="text-red-300" />
          </TextField>
          ...
          <div>
            <Select name="vaccinationStatus" className="w-full">
              <Label className="text-white/80 text-sm mb-1 block">Vaccination Status</Label>
              <Select.Trigger className="rounded-2xl bg-white/10 border border-white/20 text-white backdrop-blur-sm">
              ...
              <Select.Popover>
                <ListBox>
                  ...
                  <ListBox.Item id="Partial" textValue="Partial">Partial<ListBox.ItemIndicator /></ListBox.Item>
                </ListBox>
              </Select.Popover>
            </Select>
          </div>
          ...
          <div className="md:col-span-2">
            <TextField name="imageUrl" isRequired>
              <Label className="text-white/80 text-sm mb-1 block">Pet Image URL <span className=" text-xs">(upload to imgbb.com first)</span></Label>
              <Input type="url" placeholder="https://i.ibb.co/..." className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
              <FieldError className="text-red-300" />
            </TextField>
          </div>
          ...
          <div>
            <Select name="healthStatus" isRequired className="w-full">
              <Label className="text-white/80 text-sm mb-1 block">Health Status</Label>
              <Select.Trigger className="rounded-2xl bg-white/10 border border-white/20 text-white backdrop-blur-sm">
              ...
              <Select.Popover>
                <ListBox>
                  ...
                  <ListBox.Item id="Minor Issues" textValue="Minor Issues">Minor Issues<ListBox.ItemIndicator /></ListBox.Item>
                  <ListBox.Item id="Needs Care" textValue="Needs Care">Needs Care<ListBox.ItemIndicator /></ListBox.Item>
                </ListBox>
              </Select.Popover>
            </Select>
          </div>
          ...
          <TextField name="location" isRequired>
            ...
            <Input placeholder="e.g. New York, NY" className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
            <FieldError className="text-red-300" />
          </TextField>

          {/* Adoption Fee */}
          <TextField name="adoptionFee">
            <Label className="text-white/80 text-sm mb-1 block">Adoption Fee ($) <span className=" text-xs">— Enter 0 for free</span></Label>
            <Input type="number" placeholder="0" className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
            <FieldError className="text-red-300" />
          </TextField>

          {/* Owner Email */}
          <TextField name="ownerEmail" isRequired>
            <Label className="text-white/80 text-sm mb-1 block">Owner Email</Label>
            <Input type="email" placeholder="you@example.com" className="rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/40 backdrop-blur-sm" />
            <FieldError className="text-red-300" />
          </TextField>
